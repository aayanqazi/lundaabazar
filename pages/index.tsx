  ...
  <Layout title="Lundaa Baza Online">
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        <h3 className="lg:text-2xl text-xl uppercase tracking-wider">
          Coming soon
        </h3>
        <h3 className="text-4xl lg:text-6xl font-extrabold">Lundaa Bazar</h3>
        <h1 className="text-7xl lg:text-9xl font-extrabold">We’r blowing up</h1>
        <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xl lg:mx-auto">
          Our website under construction but facebook and instagram is working.
          Check back for an update soon. Stay in touch!
        </p>
      </div>
    </div>
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link
            href="https://www.instagram.com/lundaa.bazar/"
            passHref
            legacyBehavior
            target="_blank"
          >
        ...
        <li>
          <Link
            target="_blank"
            href="https://www.facebook.com/lundaabazar/"
            passHref
            legacyBehavior
          >
            <a
